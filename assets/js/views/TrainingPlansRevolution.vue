...
<script>
import TrainingPlanRevolution from "../components/TrainingPlanRevolution";
...
export default {
  ...
  methods: {
    ...
    async showTrainingPlan(trainingPlan) {
      ...
      this.currentPanel = this.trainingPlanLayoutText === 'Split' ? 'TrainingPlanSplit' : 'TrainingPlanRevolution';
    ...
    switchTrainingPlanLayout(trainingPlanLayout) {
      ...
      if ('show' === this.panelMode) {
        this.currentPanel = 'Split' === this.trainingPlanLayoutText ? 'TrainingPlanSplit' : 'TrainingPlanRevolution';
