...
final class DevicesTest extends ApiTestCase
{
    ...
    private const DEVICES_ENDPOINT = '/api/devices';
    ...
    {
        $this->apiHelper->request(Request::METHOD_GET, self::DEVICES_ENDPOINT);
    ...
    public function testEmptyNameNotAccepted(): void
    {
        ...
        $response = $this->apiHelper->request(Request::METHOD_POST, self::DEVICES_ENDPOINT, ['Name' => ' ']);
