...
#[ORM\Table(name: 'device_options')]
#[ORM\Index(name: 'IDX_device_option_creator', columns: ['creator'])]
#[ORM\Index(name: 'IDX_device_option_id', columns: ['id'])]
#[ORM\Index(name: 'IDX_device_option_updater', columns: ['updater'])]
#[ORM\UniqueConstraint(name: 'UN_device_option_name', columns: ['name'])]
#[ORM\Entity]
